...
<form action="{{ $action }}" id="productForm" enctype="multipart/form-data">
    <div class="container">
        <div class="row">
            <div class="col-md-2 col-sm-3 col-xs-3 bg-info bgblue">分類<span> *</span></div>
        ...
        <div class="row">
            <div class="col-md-2 col-sm-3 col-xs-3 bg-info bgblue">產品名稱<span> *</span></div>
            <div class="col-md-4 col-sm-9 col-xs-9">
                <input class="form-control" style="border-radius:5px;" type="text" name="product_title" value="{{ $product->product_title ?? '' }}">
            </div>
        </div><br>
        <div class="row">
            <div class="col-md-2 col-sm-3 col-xs-3 bg-info bgblue">口味<span> *</span></div>
            <!-- <div class="col-md-4 col-sm-9 col-xs-9">
        ...
        <div class="row">
            <div class="col-md-2 col-sm-3 col-xs-3 bg-info bgblue">價格<span> *</span></div>
            <div class="col-md-4 col-sm-9 col-xs-9">
